            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-slate-800 dark:to-slate-700">
                  ...
                  <p ref={profileEmailRef} title={userData?.email || ''} className="text-base font-bold text-slate-900 dark:text-white mt-1 text-center w-full max-w-full whitespace-nowrap">{userData?.email || 'No disponible'}</p>
                </div>
